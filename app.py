...
df = pd.read_csv(r"C:\Users\Admin\Desktop\PROJECT\earthquake.csv")
...
cleaned_data= "eq_data.csv"
df.to_csv(cleaned_data , index = False)
df = pd.read_csv(r"C:\Users\Admin\Desktop\PROJECT\eq_data.csv")
print(df)
...
try:
 ...
 password = '12345', database = 'miniproject1',cursorclass=pymysql.cursors.DictCursor
 )
